...
`) throw new Error(u);
    ...
    function Tt(e1, n, r, u = l.defTex, c = l.defShader, s = {}) {
        ...
        for (let o of n)l.iqueue.push(o + l.vqueue.length / Ye - e1.length);
    ...
    function pn(e1) {
        ...
        if (!(n.length < 2)) {
            ...
            } else for(let r = 0; r < n.length - 1; r++)qe(D(P({}, e1), {
                p1: n[r],
                p2: n[r + 1]
            }));
        }
    ...
    function bn() {
        ...
        if (i.letterbox) {
            ...
            if (s > o) {
                ...
                e1.scissor(m, 0, d, h), e1.viewport(m, 0, d, r), l.viewport = {
                    x: m,
                    y: 0,
                    width: d,
                    height: r
                ...
                e1.scissor(0, m, d, h), e1.viewport(0, m, n, h), l.viewport = {
                    x: 0,
                    y: m,
                    width: n,
                    height: h
...
},{}]},["9ZIyz","adjPd"], "adjPd", "parcelRequirefb0c")
